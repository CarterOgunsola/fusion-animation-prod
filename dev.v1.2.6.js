...
(function (Qe) {
      ...
      if (
        ...
        if (t.slidesPerView === "auto") {
          ...
          if (
            ...
            M = s.isHorizontal() ? ia(I, "width") : ia(I, "height");
          else {
            const D = e(P, "width"),
              z = e(P, "padding-left"),
              A = e(P, "padding-right"),
  ...
  function Ef(s) {
    ...
    i("changeDirection", () => {
      ...
      i("init", () => {
        e.params.scrollbar.enabled === !1 ? I() : (M(), d(), h());
      }),
      ...
      if (
        ...
        if (
          ...
          if (((T = v.length), (E = m && El(m)), ui(m)))
            for (M in m) ~Vl.indexOf(M) && (I || (I = {}), (I[M] = m[M]));
          for (b = 0; b < T; b++)
            (S = ln(r, Hl)),
              (S.stagger = 0),
              w && (S.yoyoEase = w),
              ...
              if (!(T && !G && !V)) {
                ...
                if (
                  (Z &&
                    ((Te = xe),
                    (xe = T ? B() : Q),
                    _ && ((Mr = Zi), (Zi = r && !I ? r.totalProgress() : le))),
                  g &&
                    h &&
                    !ot &&
                    !En &&
