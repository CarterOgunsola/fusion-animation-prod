...
var pt = Math.pow,
  lo = (Ze, ze, ht) =>
    ze in Ze
      ...
      : (Ze[ze] = ht),
  Ln = (Ze, ze) => {
    for (var ht in ze || (ze = {})) hh.call(ze, ht) && lo(Ze, ht, ze[ht]);
    if (Nu) for (var ht of Nu(ze)) mh.call(ze, ht) && lo(Ze, ht, ze[ht]);
    return Ze;
  },
  uo = (Ze, ze) => fh(Ze, ph(ze));
var q = (Ze, ze, ht) => lo(Ze, typeof ze != "symbol" ? ze + "" : ze, ht);
(function (Ze) {
  ...
  function po(s) {
    return s === void 0 && (s = {}), In || (In = Ku(s)), In;
  }
  let Rn;
  function Zu() {
    const s = we(),
          ...
          ((n = new ResizeObserver((h) => {
            a = r.requestAnimationFrame(() => {
              ...
              let f = m,
                d = p;
              h.forEach((g) => {
                let { contentBoxSize: y, contentRect: D, target: v } = g;
                (v && v !== e.el) ||
                  ((f = D ? D.width : (y[0] || y).inlineSize),
                  (d = D ? D.height : (y[0] || y).blockSize));
              }),
                (f !== m || d !== p) && o();
            });
          })),
  ...
  function ic() {
    ...
    for (let x = 0; x < h; x += 1) {
      ...
      if (
        ...
        if (t.slidesPerView === "auto") {
          ...
          (S = (n - (t.slidesPerView - 1) * v) / t.slidesPerView),
            t.roundLengths && (S = Math.floor(S)),
    ...
    if (
      ...
      p.length !== D && s.emit("slidesGridLengthChange"),
  ...
  var wc = { setTransition: Dc, transitionStart: yc, transitionEnd: _c };
  function bc(s, e, t, i, r) {
    ...
    if (!(v && r) && ((m && -y === n.translate) || (!m && y === n.translate)))
      return (
        ...
        D !== "reset" && (n.transitionStart(t, D), n.transitionEnd(t, D)),
        !1
      );
    if (o.cssMode) {
    ...
    const T = ho().isSafari;
    return (
      v && !r && T && n.isElement && n.virtual.update(!1, !1, a),
      n.setTransition(e),
      n.setTranslate(y),
      n.updateActiveIndex(a),
      n.updateSlidesClasses(),
      n.emit("beforeTransitionStart", e, i),
      n.transitionStart(t, D),
      e === 0
        ? n.transitionEnd(t, D)
        : n.animating ||
          ((n.animating = !0),
  ...
  function Ec(s, e, t) {
    ...
    if (typeof g == "undefined" && (r.cssMode || d)) {
      ...
      n.forEach((v, _) => {
        ...
        typeof D != "undefined" && (g = d ? n[D] : n[D > 0 ? D - 1 : D]);
    }
    let y = 0;
    if (
      (typeof g != "undefined" &&
  ...
  function Fc(s) {
    ...
    y === "auto"
      ...
      : ((y = Math.ceil(parseFloat(f.slidesPerView, 10))),
        d && y % 2 === 0 && (y = y + 1));
    const D = f.slidesPerGroupAuto ? y : f.slidesPerGroup;
    let v = D;
    v % D !== 0 && (v += D - (v % D)),
    ...
    const w = [],
      T = [],
      b = _ ? Math.ceil(c.length / f.grid.rows) : c.length,
      S = a && b - g < y && !d;
    ...
    let P = 0,
      k = 0;
    const R =
      (_ ? c[n].column : n) + (d && typeof r == "undefined" ? -y / 2 + 0.5 : 0);
    if (R < v) {
      P = Math.max(v - R, D);
      for (let z = 0; z < v - R; z += 1) {
        const M = z - Math.floor(z / b) * b;
        if (_) {
          const F = b - M - 1;
      ...
      (k = Math.max(R - (b - v * 2), D)), S && (k = Math.max(k, y - b + g + 1));
      for (let z = 0; z < k; z += 1) {
        const M = z - Math.floor(z / b) * b;
        _
          ? c.forEach((F, A) => {
    ...
    if (
      ...
      f.slidesPerView === "auto"
        ...
        : _ &&
          ...
          l.slides.forEach((z, M) => {
            l.grid.updateSlide(M, z, l.slides);
          }),
      ...
      if (w.length > 0 && L) {
        if (typeof e == "undefined") {
          ...
          const z = _ ? w.length / f.grid.rows : w.length;
        ...
        if (typeof e == "undefined") {
          ...
          const z = _ ? T.length / f.grid.rows : T.length;
          l.slideTo(l.activeIndex - z, 0, !1, !0);
        }
    }
    if (
  ...
  var Ic = { setGrabCursor: Oc, unsetGrabCursor: zc };
  function Rc(s, e) {
    e === void 0 && (e = this);
    function t(i) {
  ...
  function Nc(s) {
    ...
    if (m > a.longSwipesMs) {
      ...
      e.swipeDirection === "next" &&
        (v >= a.longSwipesRatio
          ? e.slideTo(a.rewind && e.isEnd ? y : d + _)
          : e.slideTo(d)),
        e.swipeDirection === "prev" &&
          (v > 1 - a.longSwipesRatio
            ? e.slideTo(d + _)
            : D !== null && v < 0 && Math.abs(v) > a.longSwipesRatio
            ? e.slideTo(D)
            : e.slideTo(d));
    } else {
      if (!a.shortSwipes) {
      ...
      (i.target === e.navigation.nextEl || i.target === e.navigation.prevEl)
        ? i.target === e.navigation.nextEl
          ? e.slideTo(d + _)
          : e.slideTo(d)
        : (e.swipeDirection === "next" && e.slideTo(y !== null ? y : d + _),
          e.swipeDirection === "prev" && e.slideTo(D !== null ? D : d));
    }
  }
  function Do() {
    const s = this,
  ...
  const _o = (s, e) => s.grid && e.grid && e.grid.rows > 1;
  function Uc() {
    const s = this,
    ...
    const y = h.direction && h.direction !== i.direction,
      D = i.loop && (h.slidesPerView !== i.slidesPerView || y),
      v = i.loop;
    y && t && s.changeDirection(), At(s.params, h);
  ...
  function sd(s) {
    ...
    function l(f, d, g) {
      ...
      let R, z;
      v
        ? ((R = Math.floor(y / 2) + D + b), (z = Math.floor(y / 2) + D + T))
        : ((R = y + (D - 1) + b), (z = (_ ? y : D) + T));
      let M = k - z,
        F = k + R;
      _ || ((M = Math.max(M, 0)), (F = Math.min(F, x.length - 1)));
      let A = (e.slidesGrid[M] || 0) - (e.slidesGrid[0] || 0);
      _ && k >= z
        ? ((M -= z), v || (A += e.slidesGrid[0]))
        : _ && k < z && ((M = -z), v && (A += e.slidesGrid[0])),
      ...
      const se = _ ? -x.length : 0,
        B = _ ? x.length * 2 : x.length;
      for (let $ = se; $ < B; $ += 1)
        if ($ >= M && $ <= F) {
          const N = _e($);
    ...
    function h(f) {
      ...
      if (Array.isArray(f)) {
        for (let D = 0; D < f.length; D += 1)
          f[D] && e.virtual.slides.unshift(f[D]);
        (g = d + f.length), (y = f.length);
      } else e.virtual.slides.unshift(f);
      if (e.params.virtual.cache) {
        const D = e.virtual.cache,
          v = {};
        Object.keys(D).forEach((_) => {
          const w = D[_],
            T = w.getAttribute("data-swiper-slide-index");
          T && w.setAttribute("data-swiper-slide-index", parseInt(T, 10) + y),
            (v[parseInt(_, 10) + y] = w);
        }),
          (e.virtual.cache = v);
      }
  ...
  function nd(s) {
    ...
    function o(c) {
      ...
      if (
        (!e.allowSlideNext &&
          ((e.isHorizontal() && D) || (e.isVertical() && _) || g)) ||
        (!e.allowSlidePrev &&
      ...
      if (
        ...
        if (e.params.keyboard.onlyInViewport && (d || g || y || D || v || _)) {
          let w = !1;
          if (
        ...
        e.isHorizontal()
          ? ((d || g || y || D) &&
            ...
            (((g || D) && !h) || ((d || y) && h)) && e.slideNext(),
            (((d || y) && !h) || ((g || D) && h)) && e.slidePrev())
          : ((d || g || v || _) &&
              (m.preventDefault ? m.preventDefault() : (m.returnValue = !1)),
            (g || _) && e.slideNext(),
            (d || v) && e.slidePrev()),
  ...
  function ad(s) {
    ...
    function c(v) {
      let b = 0,
        ...
        x = 0;
      return (
        "detail" in v && (S = v.detail),
        "wheelDelta" in v && (S = -v.wheelDelta / 120),
        "wheelDeltaY" in v && (S = -v.wheelDeltaY / 120),
        "wheelDeltaX" in v && (b = -v.wheelDeltaX / 120),
        "axis" in v && v.axis === v.HORIZONTAL_AXIS && ((b = S), (S = 0)),
        (E = b * 10),
        (x = S * 10),
    ...
    function d(v) {
      ...
      if (
        ...
        w && e.params.nested && _.stopPropagation(),
    ...
    i("init", () => {
      ...
      i("destroy", () => {
        e.params.cssMode && y(), e.mousewheel.enabled && D();
      }),
      Object.assign(e.mousewheel, { enable: y, disable: D });
  }
  function Xn(s, e, t, i) {
    return (
  ...
  function od(s) {
    ...
    function c() {
      ...
      Object.assign(e.navigation, { nextEl: d, prevEl: g }),
        ...
        (g = ae(g));
      const y = (D, v) => {
        D && D.addEventListener("click", v === "next" ? l : u),
          !e.enabled && D && D.classList.add(...f.lockClass.split(" "));
      };
      d.forEach((D) => y(D, "next")), g.forEach((D) => y(D, "prev"));
    }
    function h() {
      let { nextEl: f, prevEl: d } = e.navigation;
      (f = ae(f)), (d = ae(d));
      const g = (y, D) => {
        y.removeEventListener("click", D === "next" ? l : u),
    ...
    i("init", () => {
      ...
      i("click", (f, d) => {
        ...
        (g = ae(g)), (y = ae(y));
        const D = d.target;
        let v = y.includes(D) || g.includes(D);
        if (e.isElement && !v) {
          const _ = d.path || (d.composedPath && d.composedPath());
          _ && (v = _.find((w) => g.includes(w) || y.includes(w)));
        }
        if (e.params.navigation.hideOnClick && !v) {
          ...
          g.length
            ...
            : y.length &&
              (_ = y[0].classList.contains(e.params.navigation.hiddenClass)),
  ...
  function ld(s) {
    ...
    function l(D, v) {
      ...
      D &&
        ((D = D[`${v === "prev" ? "previous" : "next"}ElementSibling`]),
        D &&
          (D.classList.add(`${_}-${v}`),
          (D = D[`${v === "prev" ? "previous" : "next"}ElementSibling`]),
          D && D.classList.add(`${_}-${v}-${v}`)));
    }
    function c(D, v, _) {
      if (((D = D % _), (v = v % _), v === D + 1)) return "next";
      if (v === D - 1) return "previous";
    }
    function h(D) {
      const v = D.target.closest(yi(e.params.pagination.bulletClass));
      if (!v) return;
      D.preventDefault();
      const _ = jr(v) * e.params.slidesPerGroup;
      if (e.params.loop) {
        if (e.realIndex === _) return;
        const w = c(e.realIndex, _, e.slides.length);
        w === "next"
          ? e.slideNext()
          : w === "previous"
          ? e.slidePrev()
      ...
      if (
        ...
        if (
          (v.dynamicBullets &&
            ...
            v.dynamicMainBullets > 1 &&
              ...
              o > v.dynamicMainBullets - 1
                ...
                : o < 0 && (o = 0)),
            (x = Math.max(w - o, 0)),
            (L = x + (Math.min(E.length, v.dynamicMainBullets) - 1)),
            (P = (L + x) / 2)),
          E.forEach((k) => {
            const O = [
              ...[
          ...
          if (
            ...
            for (let z = x; z <= L; z += 1)
              E[z] &&
                E[z].classList.add(...`${v.bulletActiveClass}-main`.split(" "));
            l(O, "prev"), l(R, "next");
          }
        }
        if (v.dynamicBullets) {
          const k = Math.min(E.length, v.dynamicMainBullets + 4),
            ...
            R = D ? "right" : "left";
          E.forEach((z) => {
            z.style[e.isHorizontal() ? R : "top"] = `${O}px`;
          });
        }
      }
      _.forEach((E, x) => {
        if (
          (v.type === "fraction" &&
            (E.querySelectorAll(yi(v.currentClass)).forEach((L) => {
              L.textContent = v.formatFractionCurrent(w + 1);
            }),
            E.querySelectorAll(yi(v.totalClass)).forEach((L) => {
              L.textContent = v.formatFractionTotal(S);
            })),
          v.type === "progressbar")
        ) {
          let L;
        ...
        v.type === "custom" && v.renderCustom
          ? ((E.innerHTML = v.renderCustom(e, w + 1, S)),
    ...
    function p() {
      ...
      if (D.type === "bullets") {
        ...
        for (let b = 0; b < T; b += 1)
          D.renderBullet
            ? (w += D.renderBullet.call(e, b, D.bulletClass))
            : (w += `<${D.bulletElement} ${
      ...
      D.type === "fraction" &&
        (D.renderFraction
          ? (w = D.renderFraction.call(e, D.currentClass, D.totalClass))
          : (w = `<span class="${D.currentClass}"></span> / <span class="${D.totalClass}"></span>`)),
        D.type === "progressbar" &&
          (D.renderProgressbar
            ? (w = D.renderProgressbar.call(e, D.progressbarFillClass))
            : (w = `<span class="${D.progressbarFillClass}"></span>`)),
        (e.pagination.bullets = []),
        _.forEach((T) => {
          D.type !== "custom" && (T.innerHTML = w || ""),
            D.type === "bullets" &&
              e.pagination.bullets.push(
                ...T.querySelectorAll(yi(D.bulletClass))
              );
        }),
        D.type !== "custom" && r("paginationRender", _[0]);
    }
    function f() {
      ...
      if (!D.el) return;
      let v;
      typeof D.el == "string" && e.isElement && (v = e.el.querySelector(D.el)),
        !v &&
          typeof D.el == "string" &&
          (v = [...document.querySelectorAll(D.el)]),
        v || (v = D.el),
        !(!v || v.length === 0) &&
          (e.params.uniqueNavElements &&
            typeof D.el == "string" &&
          ...
          v.forEach((_) => {
            D.type === "bullets" &&
              D.clickable &&
              _.classList.add(...(D.clickableClass || "").split(" ")),
              _.classList.add(D.modifierClass + D.type),
              _.classList.add(
                e.isHorizontal() ? D.horizontalClass : D.verticalClass
              ),
              D.type === "bullets" &&
                D.dynamicBullets &&
                (_.classList.add(`${D.modifierClass}${D.type}-dynamic`),
                (o = 0),
                D.dynamicMainBullets < 1 && (D.dynamicMainBullets = 1)),
              D.type === "progressbar" &&
                D.progressbarOpposite &&
                _.classList.add(D.progressbarOppositeClass),
              D.clickable && _.addEventListener("click", h),
              e.enabled || _.classList.add(D.lockClass);
          }));
    }
    function d() {
      const D = e.params.pagination;
      ...
      v &&
        ((v = ae(v)),
        v.forEach((_) => {
          _.classList.remove(D.hiddenClass),
            _.classList.remove(D.modifierClass + D.type),
            _.classList.remove(
              e.isHorizontal() ? D.horizontalClass : D.verticalClass
            ),
            D.clickable &&
              (_.classList.remove(...(D.clickableClass || "").split(" ")),
              _.removeEventListener("click", h));
        })),
        e.pagination.bullets &&
          e.pagination.bullets.forEach((_) =>
            _.classList.remove(...D.bulletActiveClass.split(" "))
          );
    }
    i("changeDirection", () => {
      ...
      (v = ae(v)),
        v.forEach((_) => {
          _.classList.remove(D.horizontalClass, D.verticalClass),
            _.classList.add(
              e.isHorizontal() ? D.horizontalClass : D.verticalClass
            );
        });
  ...
  function ud(s) {
    ...
    function y(P) {
      ...
      (z =
        ...
        O && (z = 1 - z);
      const M = e.minTranslate() + (e.maxTranslate() - e.minTranslate()) * z;
      e.updateProgress(M),
        e.setTranslate(M),
        e.updateActiveIndex(),
        e.updateSlidesClasses();
    ...
    function S() {
      ...
      let z;
      R &&
        ((z = R.querySelector(yi(e.params.scrollbar.dragClass))),
        z || ((z = Ft("div", e.params.scrollbar.dragClass)), R.append(z))),
        Object.assign(P, { el: R, dragEl: z }),
        O.draggable && T(),
        R &&
  ...
  function dd(s) {
    ...
    function S(B) {
      ...
      if (((h = !1), (m = !1), p.push(B), !(p.length < 2))) {
        if (((h = !0), (f.scaleStart = D()), !f.slideEl)) {
    ...
    function F(B) {
      ...
      const G = (B.clientX - l.x) * c,
        ...
        ut = Math.max(Math.min(d.startY + ce, I), Xe);
      (f.imageWrapEl.style.transitionDuration = "0ms"),
    ...
    function A(B) {
      ...
      let G, ce, tt, Se, xe, J, ne, De, Xe, I, $e, ut, Yt, ye, Xt, Qt, ti, Ae;
      ...
      ($.scale = pe || Pt),
        ...
        B && !(a === 1 && pe)
          ? ((ti = f.slideEl.offsetWidth),
            ...
            (I = f.imageEl.offsetHeight || f.imageEl.clientHeight),
            ($e = Xe * $.scale),
            (ut = I * $.scale),
            (Yt = Math.min(ti / 2 - $e / 2, 0)),
            (ye = Math.min(Ae / 2 - ut / 2, 0)),
            (Xt = -Yt),
            (Qt = -ye),
            Jt > 0 &&
            pe &&
  ...
  function fd(s) {
    ...
    function r(l, c) {
      const h = (function () {
        let d, g, y;
        return (D, v) => {
          for (g = -1, d = D.length; d - g > 1; )
            (y = (d + g) >> 1), D[y] <= v ? (g = y) : (d = y);
          return d;
        };
      })();
  ...
  function pd(s) {
    ...
    function w() {
      ...
      F && (e.isBeginning ? (D(F), h(F)) : (v(F), c(F))),
        M && (e.isEnd ? (D(M), h(M)) : (v(M), c(M)));
    }
    function T() {
      return (
      ...
      T() &&
        e.pagination.bullets.forEach((F) => {
          e.params.pagination.clickable &&
            ...
            F.matches(yi(e.params.pagination.bulletActiveClass))
    ...
    const E = (M, F, A) => {
        c(M),
          M.tagName !== "BUTTON" &&
            (m(M, "button"), M.addEventListener("keydown", _)),
          d(M, A),
          f(M, F);
      },
      x = (M) => {
      ...
      R = () => {
        ...
        g(A, C), y(A, X), O();
        let { nextEl: Q, prevEl: _e } = e.navigation ? e.navigation : {};
        (Q = ae(Q)),
          (_e = ae(_e)),
    ...
    function z() {
      ...
      (M = ae(M)),
        (F = ae(F)),
        M && M.forEach((C) => C.removeEventListener("keydown", _)),
        F && F.forEach((C) => C.removeEventListener("keydown", _)),
        b() &&
          ae(e.pagination.el).forEach((X) => {
            X.removeEventListener("keydown", _);
          }),
      ...
      u = (p, f) => {
        ...
        const y =
          e.virtual && e.params.virtual.enabled
            ...
            : e.slides[f];
        let D = a(y.getAttribute("data-history"));
        if (e.params.history.root.length > 0) {
          let _ = e.params.history.root;
          _[_.length - 1] === "/" && (_ = _.slice(0, _.length - 1)),
            (D = `${_}/${p ? `${p}/` : ""}${D}`);
        } else g.pathname.includes(p) || (D = `${p ? `${p}/` : ""}${D}`);
        e.params.history.keepQuery && (D += g.search);
        const v = d.history.state;
        (v && v.value === D) ||
          (e.params.history.replaceState
            ? d.history.replaceState({ value: D }, null, D)
            : d.history.pushState({ value: D }, null, D));
      },
      l = (p, f, d) => {
        if (f)
          for (let g = 0, y = e.slides.length; g < y; g += 1) {
            const D = e.slides[g];
            if (a(D.getAttribute("data-history")) === f) {
              const _ = e.getSlideIndex(D);
              e.slideTo(_, p, d);
            }
          }
  ...
  function gd(s) {
    ...
    function v(F) {
      !e ||
        ...
        (F.target === e.wrapperEl &&
          ...
          !(D || (F.detail && F.detail.bySwiperTouchMove)) && x()));
    }
    const _ = () => {
      ...
      L = () => {
        if (e.destroyed || !e.autoplay.running) return;
        const F = Ve();
        F.visibilityState === "hidden" && ((y = !0), E(!0)),
          F.visibilityState === "visible" && x();
      },
      P = (F) => {
        F.pointerType === "mouse" &&
          ((y = !0), (D = !0), !(e.animating || e.autoplay.paused) && E(!0));
      },
      k = (F) => {
        F.pointerType === "mouse" && ((D = !1), e.autoplay.paused && x());
      },
      O = () => {
    ...
    i("init", () => {
      e.params.autoplay.enabled && (O(), z(), b());
    }),
      i("destroy", () => {
  ...
  function vd(s) {
    ...
    function u(l) {
      ...
      if (e.realIndex !== c.realIndex || d) {
        ...
        } else (y = e.realIndex), (D = y > e.previousIndex ? "next" : "prev");
        d && (y += D === "next" ? f : -1 * f),
      ...
      if (c.freeMode.momentum) {
        ...
        if (v < e.maxTranslate())
          c.freeMode.momentumBounce
            ? (v + e.maxTranslate() < -T && (v = e.maxTranslate() - T),
              (w = e.maxTranslate()),
              (_ = !0),
          ...
          c.freeMode.momentumBounce
            ? (v - e.minTranslate() > T && (v = e.minTranslate() + T),
              (w = e.minTranslate()),
              (_ = !0),
              (f.allowMomentumBounce = !0))
            : (v = e.minTranslate()),
          ...
          Math.abs(p[S] - v) < Math.abs(p[S - 1] - v) ||
          e.swipeDirection === "next"
            ? (v = p[S])
            : (v = p[S - 1]),
            (v = -v);
        ...
        if (
          ...
          if (
            ...
            const S = Math.abs((m ? -v : v) - e.translate),
  ...
  function yd(s) {
    ...
    const u = () => {
      ...
      h = (d, g, y) => {
        ...
        let b, S, E;
        if (w === "row" && D > 1) {
          const x = Math.floor(d / (D * _)),
            L = d - _ * D * x,
            P = x === 0 ? D : Math.min(Math.ceil((T - x * _ * D) / _), D);
          (E = Math.floor(L / P)),
            (S = L - E * P + x * D),
            (b = S + (E * r) / _),
            (g.style.order = b);
      ...
      m = (d, g) => {
        const { centeredSlides: y, roundLengths: D } = e.params,
          v = u(),
        ...
        if (
          ...
          for (let T = 0; T < g.length; T += 1) {
            let b = g[T];
            D && (b = Math.floor(b)), g[T] < e.virtualSize + g[0] && w.push(b);
          }
    ...
    _r({
      ...
      setTranslate: () => {
        ...
        for (let b = 0; b < c.length; b += 1) {
          const S = c[b];
          let E = b;
          v && (E = parseInt(S.getAttribute("data-swiper-slide-index"), 10));
          let x = E * 90,
            L = Math.floor(x / 360);
          ...
          E % 4 === 0
            ...
            p && (k = -k),
            D || ((O = k), (k = 0));
          const z = `rotateX(${g(D ? 0 : -x)}deg) rotateY(${g(
            D ? x : 0
          )}deg) translate3d(${k}px, ${O}px, ${R}px)`;
          P <= 1 &&
            P > -1 &&
            ((_ = E * 90 + P * 90), p && (_ = -E * 90 - P * 90)),
            (S.style.transform = z),
            y.slideShadows && r(S, P, D);
        }
        if (
          ...
          if (D)
            ...
            const b = Math.abs(_) - Math.floor(Math.abs(_) / 90) * 90,
              S =
                1.5 -
    ...
    _r({
      ...
      setTranslate: () => {
        ...
        for (let m = 0; m < u.length; m += 1) {
          ...
          const w = `translate3d(${v}px, ${_}px, 0px) rotateX(${h(
              D
            )}deg) rotateY(${h(y)}deg)`,
            T = Zr(c, p);
          T.style.transform = w;
      ...
      _r({
        ...
        setTranslate: () => {
          const { width: a, height: o, slides: u, slidesSizesGrid: l } = e,
            ...
            d = c.depth,
            g = Bs(e);
          for (let y = 0, D = u.length; y < D; y += 1) {
            const v = u[y],
              _ = l[y],
            ...
            if (
              ...
              M || (M = wr("coverflow", v, h ? "left" : "top")),
                F || (F = wr("coverflow", v, h ? "right" : "bottom")),
    ...
    _r({
      ...
      setTranslate: () => {
        ...
        for (let f = 0; f < o.length; f += 1) {
          ...
          y < 0 ? ((b = c.next), (T = !0)) : y > 0 && ((b = c.prev), (T = !0)),
            _.forEach((O, R) => {
              _[R] = `calc(${O}px + (${r(b.translate[R])} * ${Math.abs(
                y * h
              )}))`;
            }),
            w.forEach((O, R) => {
              let z = b.rotate[R] * Math.abs(y * h);
              w[R] = z;
            }),
          ...
          const S = _.join(", "),
            ...
            x =
              D < 0
                ? `scale(${1 + (1 - b.scale) * D * h})`
                : `scale(${1 - (1 - b.scale) * D * h})`,
            L =
              D < 0 ? 1 + (1 - b.opacity) * D * h : 1 - (1 - b.opacity) * D * h,
            P = `translate3d(${S}) ${E} ${x}`;
          if ((T && b.shadow) || !T) {
      ...
      _r({
        ...
        setTranslate: () => {
          ...
          for (let p = 0; p < a.length; p += 1) {
            ...
            let D = e.params.cssMode ? -y - e.translate : -y,
              v = 0;
   ...
   */ var Lt = {
    ...
    es = function (e) {
      var t = e.parent || Te,
        i = e.keyframes ? Yd(st(e.keyframes)) : zt;
      if (St(e.inherit))
    ...
    Cr = function (e, t, i, r) {
      ...
      return (
        ...
        (e._dur = a),
        (e._tDur = n ? (n < 0 ? 1e10 : Ie(a * (n + 1) + e._rDelay * n)) : a),
    ...
    il = function (e, t, i) {
      ...
      if (
        ...
        for (l = e.replace(zi, "1").split(Sr), h = l.length - 1; o < h; o++)
          r +=
            l[o] +
            (~u.indexOf(o)
              ? n.shift() || a + "0,0,0,0)"
      ...
      return (
        (h = {
          ...
          add: function (g, y, D) {
            var v = y
              ? function (_, w, T, b) {
                  g(_, w, T, b), h.remove(v);
                }
              : g;
            return h.remove(g), o[D ? "unshift" : "push"](v), Pr(), v;
          },
          remove: function (g, y) {
    ...
    cf = function (e) {
      ...
      return i && t.length > 1 && i.config
        ? i.config.apply(
            null,
            ~e.indexOf("{") ? [lf(t[1])] : uf(e).split(",").map(zo)
          )
        : le._CE && af.test(e)
        ? le._CE("", e)
        : i;
  ...
  var mt = (function (s) {
    ...
    function e(i, r) {
      ...
      return (
        ...
        Te && li(i.parent || Te, _i(n), r),
        i.reversed && n.reverse(),
        i.paused && n.paused(!0),
        i.scrollTrigger && Ho(_i(n), i.scrollTrigger),
        n
      );
    }
    var t = e.prototype;
    return (
        ...
        if (
          ...
          if (
            ...
            if (
              ...
              if (
                ...
                (o = S ? 0 : c % l ? l : c),
                (this._lock = 1),
                (this.render(o || (b ? 0 : Ie(d * g)), n, !l)._lock = 0),
                (this._tTime = c),
          ...
          if (
            (this._hasPause &&
              !this._forcing &&
              this._lock < 2 &&
              ((D = Ud(this, Ie(o), Ie(m))), D && (c -= m - (m = D._start))),
            (this._tTime = c),
            (this._time = m),
            (this._act = !v),
            this._initted ||
              ...
              (this._zTime = r),
              (o = 0)),
            !o && m && !n && !d && (It(this, "onStart"), this._tTime !== c))
          )
            return this;
          if (m >= o && r >= 0)
            for (p = this._first; p; ) {
              if (
                ((f = p._next), (p._act || m >= p._start) && p._ts && D !== p)
              ) {
            ...
            for (var x = r < 0 ? r : m; p; ) {
              if (
                ((f = p._prev), (p._act || x <= p._end) && p._ts && D !== p)
              ) {
                if (p.parent !== this) return this.render(r, n, a);
                if (
                  (p.render(
          ...
          if (
            ...
            !n &&
            (this.pause(),
            (D.render(m >= o ? 0 : -he)._zTime = m >= o ? 1 : -1),
            this._ts)
          )
            return (this._start = _), js(this), this.render(r, n, a);
      ...
      (t.tweenFromTo = function (r, n, a) {
        return this.tweenTo(n, zt({ startAt: { time: Gt(this, r) } }, a));
      }),
      (t.recent = function () {
        return this._recent;
      }),
  ...
  var df = function (e, t, i, r, n, a, o) {
      ...
      for (
        u.b = i,
          ...
          i += "",
          r += "",
          (y = ~r.indexOf("random(")) && (r = rs(r)),
          a && ((D = [i, r]), a(D, e, t), (i = D[0]), (r = D[1])),
          m = i.match(Kn) || [];
        (h = Kn.exec(r));
    ...
    ma = function s(e, t, i) {
      var r = e.vars,
        ...
        g = e._targets,
        y = e.parent,
        D = y && y.data === "nested" ? y.vars.targets : g,
      ...
      if (
        ...
        for (
          ...
          if (
            ...
            for (b in w)
              Ot[b] && (k = ll(b, w, e, R, E, D))
                ? k.priority && (x = 1)
                : (O[b] = S =
                    pa.call(e, E, b, "get", w[b], R, D, 0, r.stringFilter));
  ...
  var Re = (function (s) {
    ...
    function e(i, r, n, a) {
      ...
      var u = o.vars,
        ...
        y = u.yoyoEase,
        D = r.parent || Te,
        v = (st(i) || xo(i) ? wi(i[0]) : "length" in r) ? [i] : Ut(i),
        _,
        w,
        T,
        b,
        ...
        if (
          ...
          for (w = 0; w < b; w++)
            (T = Ws(r, cl)),
              ...
              L && Er(T, L),
              (E = v[w]),
              (T.duration = +ls(l, _i(o), w, E, v)),
              (T.delay = (+ls(c, _i(o), w, E, v) || 0) - o._delay),
              !m &&
                b === 1 &&
                T.delay &&
                ((o._delay = c = T.delay), (o._start += c), (T.delay = 0)),
              _.to(E, T, x ? x(w, E, v) : 0),
              (_._ease = le.none);
          _.duration() ? (l = c = 0) : (o.timeline = 0);
        } else if (f) {
          es(zt(_.vars.defaults, { ease: "none" })),
            (_._ease = Qi(f.ease || r.ease || "none"));
          var P = 0,
            k,
            O,
            R;
            ...
            for (S in T)
              for (
                ...
                (O = k[w]),
                  ...
                  _.to(v, R, P),
                  (P += R.duration);
            _.duration() < l && _.to({}, { duration: l - _.duration() });
          }
        }
        l || o.duration((l = _.duration()));
      } else o.timeline = 0;
      return (
        p === !0 && !Vn && ((Ii = _i(o)), Te.killTweensOf(v), (Ii = 0)),
        li(D, _i(o), n),
    ...
    return (
      (t.render = function (r, n, a) {
        ...
        if (!l) Gd(this, r, n, a);
          ...
          if (
            ...
            (this.ratio = D = (_ || this._ease)(m / l)),
            this._from && (this.ratio = D = 1 - D),
            m && !o && !n && !f && (It(this, "onStart"), this._tTime !== h))
          )
            return this;
          ...
          (v && v.render(r < 0 ? r : v._dur * v._ease(m / this._dur), n, a)) ||
            ...
            this._onUpdate &&
              !n &&
              (c && na(this, r, n, a), It(this, "onUpdate")),
            this._repeat &&
              f !== g &&
              this.vars.onRepeat &&
              !n &&
      ...
      (t.kill = function (r, n) {
        ...
        if (this.timeline) {
          ...
          return (
            this.timeline.killTweensOf(r, n, Ii && Ii.vars.overwrite !== !0)
              ._first || ss(this),
            this.parent &&
   ...
   */ var vl,
    ...
    Bi = function (e, t, i, r, n, a) {
      var o = new Et(e._pt, t, i, 0, 1, a ? wl : _l);
    ...
    $i = function s(e, t, i, r) {
      ...
      if (p && (t === "height" || t === "width")) {
        var D = e.style[t];
        (e.style[t] = h + r), (f = e[c]), D ? (e.style[t] = D) : rr(e, t);
      } else
        (p || a === "%") &&
          !Hf[ci(d, "display")] &&
    ...
    Yf = function (e, t, i, r) {
      ...
      if (
        ...
        for (; (h = Sr.exec(r)); )
          (g = h[0]),
            ...
            f
              ? (f = (f + 1) % 5)
              : (D.substr(-5) === "rgba(" || D.substr(-5) === "hsla(") &&
                (f = 1),
            g !== (d = m[l++] || "") &&
              ((p = parseFloat(d) || 0),
              (_ = d.substr((p + "").length)),
              g.charAt(1) === "=" && (g = xr(p, g) + _),
              (y = parseFloat(g)),
              (v = g.substr((y + "").length)),
      ...
      } else o.r = t === "display" && r === "none" ? wl : _l;
    ...
    Pa = function (e, t, i, r, n, a) {
      ...
      i
        ? u !== us &&
          (b = p * g - f * d) &&
          ((S = _ * (g / b) + w * (-d / b) + (d * D - g * y) / b),
          (E = _ * (-f / b) + w * (p / b) - (p * D - f * y) / b),
          (_ = S),
          (w = E))
        : ((T = Ml(e)),
          (_ = T.x + (~v[0].indexOf("%") ? (_ / 100) * T.width : _)),
          (w =
            T.y + (~(v[1] || v[0]).indexOf("%") ? (w / 100) * T.height : w))),
        r || (r !== !1 && o.smooth)
          ? ((y = _ - l),
            (D = w - c),
            (o.xOffset = h + (y * p + D * d) - y),
            (o.yOffset = m + (y * f + D * g) - D))
    ...
    cs = function (e, t) {
      ...
      return (
        ...
        b !== us &&
          ...
          b.length === 6
            ...
            : ((B = b[6]),
              ...
              (f = Le(Math.sqrt(z * z + B * B))),
              (S = Lr(R, z)),
              (D = Math.abs(S) > 2e-4 ? S * ir : 0),
              (_ = se ? 1 / (se < 0 ? -se : se) : 0)),
          i.svg &&
        ...
        (i.renderTransform = i.svg ? Wf : xl ? zl : Vf),
        (i.uncache = 0),
        i
      );
    },
    ...
    zl = function (e, t) {
      ...
      if (v && (h !== sr || c !== sr)) {
        ...
        (T = parseFloat(h) * Fr),
          (E = Math.cos(T)),
          (a = Aa(D, a, b * E * -v)),
          (o = Aa(D, o, -Math.sin(T) * -v)),
          (u = Aa(D, u, S * E * -v + v));
      }
      g !== ds && (_ += "perspective(" + g + nr),
        (r || n) && (_ += "translate(" + r + "%, " + n + "%) "),
        (w || a !== ds || o !== ds || u !== ds) &&
          (_ +=
            u !== ds || w
        ...
        c !== sr && (_ += "rotateY(" + c + nr),
        h !== sr && (_ += "rotateX(" + h + nr),
        (m !== sr || p !== sr) && (_ += "skew(" + m + ", " + p + nr),
        (f !== 1 || d !== 1) && (_ += "scale(" + f + ", " + d + nr),
        (D.style[Ce] = _ || "translate(0, 0)");
    },
    Wf = function (e, t) {
      var i = t || this,
        r = i.xPercent,
          ...
          if (
            ...
            if (
              (u && d in u
                ...
                : (l = Si(e, d)),
              (m = parseFloat(l)),
              (D = p === "string" && c.charAt(1) === "=" && c.substr(0, 2)),
              D && (c = c.substr(2)),
              (h = parseFloat(c)),
              d in ui &&
                (d === "autoAlpha" &&
              ...
              if (
                ...
                (this._pt = new Et(
                  ...
                  "scaleY",
                  w.scaleY,
                  (D ? xr(w.scaleY, D + h) : h) - w.scaleY || 0,
                  Ea
                )),
                  (this._pt.u = 0),
                  a.push("scaleY", d),
            ...
            if (
              ...
              (g = (l + "").substr((m + "").length)),
                h || (h = 0),
                (y = nt(c) || (d in Lt.units ? Lt.units[d] : g)),
                g !== y && (m = $i(e, d, l, y)),
                (this._pt = new Et(
                  this._pt,
                  v ? w : o,
                ...
                (this._pt.u = y || 0),
                g !== y && y !== "%" && ((this._pt.b = l), (this._pt.r = Ff));
            else if (d in o) Yf.call(this, e, d, l, D ? D + c : c);
            else if (d in e) this.add(e, d, l || e[d], D ? D + c : c, r, n);
    ...
    return (
      (e.init = function (i) {
        ...
        var tt,
          ...
          Ne = function (j, de) {
            return (
              ((I.event = j) && p && ~p.indexOf(j.target)) ||
              (de && Ae && j.pointerType !== "touch") ||
              (M && M(j, de))
            );
          },
          Pn = function () {
            I._vx.reset(), I._vy.reset(), Se.pause(), h && h(I);
          },
          Mi = function () {
            var j = (I.deltaX = Xl(Pt)),
              de = (I.deltaY = Xl(je)),
              H = Math.abs(j) >= r,
              K = Math.abs(de) >= r;
            L && (H || K) && L(I, j, de, Pt, je),
              H &&
                (w && I.deltaX > 0 && w(I),
                T && I.deltaX < 0 && T(I),
                E && E(I),
                P && I.deltaX < 0 != $e < 0 && P(I),
                ($e = I.deltaX),
                (Pt[0] = Pt[1] = Pt[2] = 0)),
              K &&
                (S && I.deltaY > 0 && S(I),
                b && I.deltaY < 0 && b(I),
                x && x(I),
                k && I.deltaY < 0 != ut < 0 && k(I),
                (ut = I.deltaY),
                (je[0] = je[1] = je[2] = 0)),
              (J || xe) &&
                (z && z(I),
                xe && (g && xe === 1 && g(I), D && D(I), (xe = 0)),
                (J = !1)),
              De && !(De = !1) && ce && ce(I),
              ne && (X(I), (ne = !1)),
              (tt = 0);
          ...
          Vr = function (j, de) {
            G &&
              !Xe &&
              ((I.axis = Xe = Math.abs(j) > Math.abs(de) ? "x" : "y"),
              (De = !0)),
              Xe !== "y" && ((Pt[2] += j), I._vx.update(j, !0)),
              Xe !== "x" && ((je[2] += de), I._vy.update(de, !0)),
              l ? tt || (tt = requestAnimationFrame(Mi)) : Mi();
          },
          Wi = function (j) {
            if (!Ne(j, 1)) {
              ...
              (I.x = de),
                ...
                (Z ||
                  ((K || W) &&
                    (Math.abs(I.startX - de) >= n ||
                      Math.abs(I.startY - H) >= n))) &&
                  ((xe = Z ? 2 : 1), Z || (I.isDragging = !0), Vr(K, W));
            }
          },
          gr = (I.onPress = function (ee) {
            Ne(ee, 1) ||
              (ee && ee.button) ||
              ((I.axis = Xe = null),
              Se.pause(),
          ...
          Ls = function (j) {
            return Ne(j) || (ms(j, c) && se(I));
          };
        (Se = I._dc = et.delayedCall(m || 0.25, Pn).pause()),
          (I.deltaX = I.deltaY = 0),
          (I._vx = ka(0, 50, !0)),
          (I._vy = ka(0, 50, !0)),
          (I.scrollX = ye),
            ...
            return (
              I.isEnabled ||
                ...
                ((a.indexOf("touch") >= 0 && Bl) ||
                  ...
                  z && gt(o, ar + "move", Dr)),
                (I.isEnabled = !0),
                (I.isDragging = I.isGesturing = I.isPressed = J = xe = !1),
                I._vx.reset(),
                I._vy.reset(),
                (Qt = ye()),
                (ti = Xt()),
          ...
          (I.disable = function () {
            I.isEnabled &&
              (zr.filter(function (ee) {
                return ee !== I && hs(ee.target);
              }).length || vt(Jt ? pe : o, "scroll", La),
              I.isPressed &&
                (I._vx.reset(), I._vy.reset(), vt(F ? o : pe, ei[1], Wi, !0)),
   ...
   */ var Y,
    ...
    Qf = function s() {
      return ys && requestAnimationFrame(s);
    },
    eu = function () {
      return (ln = 1);
    },
    ...
    Dn = function (e, t, i, r, n, a, o, u) {
      ...
      return (
        (_ += "position:" + ((g || u) && d ? "fixed;" : "absolute;")),
        (g || u || !d) &&
          (_ += (r === He ? Va : Wa) + ":" + (a + parseFloat(m)) + "px;"),
        o &&
          (_ +=
    ...
    Hr = function () {
      (!_t || !_t.isPressed || _t.startX > fe.clientWidth) &&
        (ie.cache++,
        _t ? Cs || (Cs = requestAnimationFrame(Ti)) : Ti(),
        jt || fr("scrollStart"),
        (jt = ot()));
    },
    Ka = function () {
    ...
    gu = function () {
      fe.appendChild(Br),
        (Na = (!_t && Br.offsetHeight) || re.innerHeight),
        fe.removeChild(Br);
    },
    vu = function (e) {
      return gs(
    ...
    Ti = function (e) {
      if (e === 2 || (!wt && !un)) {
        ...
        if (
          ...
          for (yt = t; yt-- > 0; ) te[yt] && te[yt].update(0, r);
          _n = 1;
        } else for (yt = 0; yt < t; yt++) te[yt] && te[yt].update(0, r);
        U.isUpdating = !1;
      }
      Cs = 0;
    },
    ...
    Du = function (e, t, i, r, n, a, o, u, l, c, h, m, p, f) {
      ...
      if ((p && p.seek(0), isNaN(e) || (e = +e), ws(e)))
        ...
        (D = Mt(t, u) || fe),
          ...
          (w = vn(v[0], _[r.d])),
          (T = vn(v[1] || "0", i)),
          (e = _[r.p] - l[r.p] - c + w + n - T),
          o && yn(o, T, r, i - T < 20 || (o._isStart && T > 20)),
          (i -= i - T);
      }
          ...
          if (
            ...
            _ &&
              ...
              (tt = lt(_.snapTo)
                ...
                : _.directional !== !1
                ? function (H, K) {
                    return Ua(_.snapTo)(H, ot() - B < 500 ? 0 : K.direction);
                  }
                : Y.utils.snap(_.snapTo)),
              (ii = _.duration || { min: 0.1, max: 2 }),
              (ii = lr(ii) ? vs(ii.min, ii.max) : vs(ii, ii)),
              (ri = Y.delayedCall(_.delay || vr / 2 || 0.1, function () {
                var H = N(),
                  K = ot() - B < 500,
                  W = G.tween;
                if (
                  ...
                  if (
                    ((Fe = tt(ct, C)),
                    ws(Fe) || (Fe = ct),
                    (Ee = Math.max(0, Math.round(J + Fe * ye))),
                    H <= ne && H >= J && Ee !== H)
                  ) {
            ...
            (ut = lr(F) ? lu(F, cu) : cu),
              (I = Dn("scroller-start", u, P, x, ut, 0)),
              ($e = Dn("scroller-end", u, P, x, ut, 0, I)),
              (Jt = I["offset" + x.op.d2]);
            ...
            (C.refresh = function (H, K, W, Z) {
              if (!((at || !C.enabled) && !K)) {
                ...
                for (
                  F &&
                  lr(W) &&
                  ((Os = Y.getProperty(I, x.p)), (Fn = Y.getProperty($e, x.p)));
                  it-- > 0;
                ...
                if (
                  ...
                  (rt = Zt(p)),
                    ...
                    R &&
                      ((ft = {
                        top: dt.top + (An ? yr - J : oo) + Ye,
                        left: dt.left + (An ? oo : yr - J) + Ye,
                ...
                ks &&
                  ...
                  (ct || $ !== C.progress || b || d || (r && !r._initted)) &&
                    ...
                    (C.progress = ct || (Se - J) / ye === $ ? 0 : $)),
                  p && f && (Ae._pinOffset = Math.round(C.progress * Ci)),
                  oe && oe.invalidate(),
                  isNaN(Os) ||
                    ((Os -= Y.getProperty(I, x.p)),
              ...
              if (!(b && !W && !H)) {
                ...
                if (
                  (K &&
                    ((xe = Se),
                    (Se = b ? N() : Z),
                    _ && ((gr = Wi), (Wi = r && !L ? r.totalProgress() : ue))),
                  g &&
                    p &&
                    !at &&
                    !cn &&
                  ...
                  _ && !G.tween && !at && !cn && ri.restart(!0),
                    o &&
                      (Me || (v && ue && (ue < 1 || !Ya))) &&
                      gs(o.targets).forEach(function (yr) {
                        return yr.classList[ct || v ? "add" : "remove"](
                          o.className
                        );
                      }),
                    a && !L && !H && a(C),
                    ni && !at
                      ? (L &&
                        ...
                        (Me || !Ya) &&
                          (l && Me && qa(C, l),
                          z[Ee] && qa(C, z[Ee]),
                          v && (ue === 1 ? C.kill(!1, 1) : (z[Ee] = 0)),
                          Me ||
                            ((Ee = ue === 1 ? 1 : 3), z[Ee] && qa(C, z[Ee]))),
                        S &&
                          !ct &&
        ...
        (s.enable = function () {
          if (
            ...
            Y &&
              ...
              (Ia = Y.core.suppressOverwrites || fi),
            ...
            for (
              a.revert ||
                ...
                za = Y.utils.checkPrefix("transform"),
                wn.push(za),
                Ir = ot(),
  ...
  (U.version = "3.12.7"),
    ...
    (U.refresh = function (s) {
      return s ? Ms(!0) : (Ir || U.register()) && hr(!0);
    }),
    (U.update = function (s) {
    ...
    fp = function (e) {
      ...
      return (
        ...
        (e.onPress = function () {
          _ = !1;
          var M = d;
          (d = _s(((re.visualViewport && re.visualViewport.scale) || 1) / g)),
            P.pause(),
        ...
        (e.onChange = function (M, F, A, C, X) {
          if (
            ...
            p.offset && x();
            var Q = X[2] === A,
              _e = Q ? O + M.startY - M.y : p() + A - X[1],
              se = S(_e);
            Q && _e !== se && (O += se - _e), p(se);
          }
          (A || F) && Ti();
        }),
        (e.onEnable = function () {
  ...
  (U.sort = function (s) {
    ...
    (U.normalizeScroll = function (s) {
      if (typeof s == "undefined") return _t;
      if (s === !0 && _t) return _t.enable();
      if (s === !1) {
        _t && _t.kill(), (_t = s);
        return;
      }
      ...
      return (
        _t && _t.target === e.target && _t.kill(), or(e.target) && (_t = e), e
      );
    }),
    (U.core = {
      _getVelocityProp: ka,
      ...
      document
        ...
        .forEach((e, t) => {
          ...
          U.create({
            ...
            onUpdate: (y) => {
              if (
                ...
                let D = y.getVelocity() * 0.006;
                (D = V.utils.clamp(-60, 60, D)),
          ...
          function g(y) {
            p = y;
            let D = { value: 1 },
              v = V.timeline({ onUpdate: () => f.timeScale(D.value) });
            y
              ? (v.fromTo(D, { value: m }, { value: 0, duration: 0.5 }),
                n.forEach((_) => _.setAttribute("marquee-status", "paused")))
              : (v.fromTo(D, { value: 0 }, { value: m, duration: 0.5 }),
  ...
  const hp = () => {
      ...
      const e = s.querySelector("[service-scroll='svg-visual-wrap']"),
        ...
        y = document.querySelectorAll("[service-list-item='wrapper']"),
        D = document.querySelectorAll("[service-list-item='3d']"),
        v = document.querySelectorAll("[service-list-icon='3d']");
      document.querySelectorAll("[service-list-text='3d']");
      const _ = document.querySelectorAll("[service-list-item='2d']"),
      ...
      S.fromTo(
        ...
        S.to(D, { opacity: 0.5, duration: 0.8, ease: "power2.in" }, "3.2"),
        S.to(v, { opacity: 0, duration: 0.8, ease: "power2.in" }, "3.2"),
        S.fromTo(
          [h, m, p],
          { y: "100%", opacity: 0 },
          {
        ...
        S.to(_, { opacity: 0.5, duration: 0.8, ease: "power2.in" }, "5.2"),
                ...
                ((typeof c == "function" && (c == null ? void 0 : c(g))) ||
                  ...
                  (r &&
                    ((D = g.hasAttribute) == null
                      ? void 0
                      : D.call(g, "data-lenis-prevent-touch"))) ||
                  (n &&
   ...
   */ var Xr,
    ...
    th = function (e, t, i, r, n, a, o) {
            ...
            (X || x || (E && !S)) &&
              ...
              b &&
                (((A._isSplit && X) ||
                  ...
                  (Q.push(A), (A._x -= l), Bu(A, e, _) && (A._wordEnd = !0)),
                A.nodeName === "BR" &&
                  ((A.nextSibling && A.nextSibling.nodeName === "BR") ||
                    z === 0) &&
                  b.push([])));
      for (z = 0; z < F; z++) {
        if (((A = C[z]), (X = A.parentNode === e), A.nodeName === "BR")) {
          b || x
          ...
          if (A._isSplit)
            ...
            A.parentNode._isSplit
              ? ((A._parent = A.parentNode),
                ...
                F--)
              : X ||
                ((N = !A.nextSibling && Bu(A.parentNode, e, _)),
      ...
      for (z = k.length; --z > -1; ) k[z].parentNode.removeChild(k[z]);
      if (b) {
        for (
          x &&
        ...
        for (_e = _ === " " && (!x || (!S && !E)), z = 0; z < b.length; z++) {
          for (
            Q = b[z],
              B = Xr.createElement(w),
              B.style.cssText =
            ...
            Q[M].nodeName !== "BR" &&
              ((A = Q[M]),
              B.appendChild(A),
              _e && A._wordEnd && B.appendChild(Xr.createTextNode(" ")),
              x &&
                (M === 0 &&
    ...
    ih = function (e, t, i, r) {
      ...
      for (
        ...
        if (((_ = d.charAt(y)), f && (T = f(d.substr(y), t.specialChars))))
          (_ = d.substr(y, T || 1)),
            (g += o && _ !== " " ? r() + _ + "</" + n + ">" : _),
            (y += T - 1);
        else if (c(_) && !c(d.charAt(y - 1)) && y) {
          ...
          _ === "{" && d.substr(y, 6) === "{{LT}}"
            ...
            ? ((D = ((d.substr(y, 12).split(Up) || [])[1] || "").length || 2),
              (g +=
                o && _ !== " "
                  ? r() + d.substr(y, D) + "</" + n + ">"
                  : d.substr(y, D)),
