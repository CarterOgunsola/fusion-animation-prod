...
(function (Qe) {
  ...
  function Xd(s) {
    ...
    typeof n == "undefined"
      ? (n = c.getSlideIndex(
          u.find((D) => D.classList.contains(f.slideActiveClass))
        ))
      : (x = n);
    const E = i === "next" || !i,
      L = i === "prev" || !i;
    ...
    if (
      ...
      if (b.length > 0 && L) {
        if (typeof e == "undefined") {
          ...
          const D = _ ? b.length / f.grid.rows : b.length;
        ...
        if (typeof e == "undefined") {
          ...
          const D = _ ? S.length / f.grid.rows : S.length;
          c.slideTo(c.activeIndex - D, 0, !1, !0);
        }
    }
    if (
  ...
  function Ef(s) {
    ...
    i("changeDirection", () => {
      ...
      i("init", () => {
        e.params.scrollbar.enabled === !1 ? L() : (M(), d(), h());
      }),
    ...
    const x = (A, k, $) => {
      ...
      z = () => {
        ...
        A.containerRoleDescriptionMessage &&
          ...
          A.containerMessage && d(k, A.containerMessage),
      ...
      setTranslate: () => {
        ...
        for (let f = 0; f < o.length; f += 1) {
          ...
          if ((S && T.shadow) || !S) {
            ...
            if ((!I && T.shadow && (I = kr("creative", d)), I)) {
      ...
      if (
        ...
        if (
          ...
          if (nt(f))
            ...
            S = {};
            for (M in f)
              M === "ease" || M === "easeEach" || Op(M, f[M], S, f.easeEach);
            for (M in S)
              for (
            ...
            (C.refresh = function (V, Z, G, Q) {
              if (!((ot || !C.enabled) && !Z)) {
                ...
                Us &&
                  ...
                  h && f && (Oe._pinOffset = Math.round(C.progress * Li)),
                  ae && ae.invalidate(),
                  isNaN(Ks) ||
    ...
    Ph = function (e) {
      ...
      return (
        ...
        (e.onChange = function (A, k, $, C, W) {
          if (
            (wr !== v && x(),
            k && i && f(T(C[2] === k ? O + (A.startX - A.x) : f() + k - C[1])),
            $)
          ) {
            h.offset && E();
            var K = W[2] === $,
        ...
        (p || m || u) &&
          (this.elements.forEach((b, S) => {
            ...
            let T = [],
              ...
              I,
              z;
            if ((mu(b, e, L, E, h, r && (u || h), g, d, f, !1), u)) {
